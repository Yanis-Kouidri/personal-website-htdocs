...
<body>
    ...
    <div id="welcome">
            <h1> Leadership </h1> 
            <span class="sous_titre"> Leading with diversity </span> 
    </div>
    ...
    <div class="section">
        ...
        <p class="block">
            However, diversity isn’t an easy concept to implement in a company or, more generally in a society. 
        ...
        <p class="block">
            ...
            It’s hard to be aware of all biases and counter them. All these biases are the source of discrimination based on name, age, sexual identity, sex, sexual orientation, wealth, physical appearance, etc. 
            It’s important to mention that all these discriminations are not necessarily intentional and can be unconscious.
        </p>

        <h4> Consequences </h4>
        <p class="block">
            They lead to a lot of bad consequences like privilege, non-diversity, exclusion, lack of innovation, etc. 
            We decide to set apart some cards that represent for us some pseudo-solution. 
            Why pseudo, because they can temporarily correct the problem but not deeply. 
            For example, imposing quotas on companies can afford diversity but a which cost? 
            Hiring a person for filling quotas is extremely degrading for the hired person because it means “I don’t hire you for your skills but for your sex (or ethnical origin, or handicap, etc.).”.
        </p>

        <h4> Personal reflection </h4>
        <p class="block">
            We need to keep in mind that people are different, and we can’t force them to go into specific sectors. 
            For example, it is easy to see that jobs related to the technology or finance sectors are often held by men. On the other hand, jobs related to care or childhood are often done by women. 
            You may think that this is due to patriarchy or some other social construction, but the studies carried out on this subject do not support this view. 
            In fact, in the most advanced countries in the world in terms of gender equality, namely Norway, Sweden, and Denmark, we notice the biggest gender disparities, with women going into care and social professions much more than into technical or scientific professions. 
            These differences in orientation can therefore be explained by biological differences. This also explains the differences in salary between men and women. 
            To learn more about this subject, here is the <a href="https://www.bbc.com/worklife/article/20190831-the-paradox-of-working-in-the-worlds-most-equal-countries" target="_blank">link to the study</a>.
            However, it is important to keep in mind that we are talking about the average here, there are many very competent women in the fields of technology and science as well as men who are very involved in the social and care professions.
            The purpose of my reflection is to alert us to certain practices that are supposed to solve the problem of diversity, but whose concrete effect is not the one expected.
    ...
    <div class="section">
        ...
        <p> <img src="./medias/images/Leadership/The_Devil_Wears_Prada_main_onesheet.jpg" alt="A single red high heel shoe, the stiletto ending in a devil's pitchfork." class="float_right"> </p>
        <h3> The devil wears Prada </h3>
        <p  class="block">
            
            I watch two films that I can link to this module. The first is “The devil wears Prada”. 
            It tells the story of Andrea, a young graduate starting a new job in the fashion industry. 
            She will quickly discover that this environment is ruthless and must make a place for herself. 
            We find ideas of Leadership, often pushed to the extreme. It also shows the difficulty of certain choices between her professional career and her private life or the respect for her values at work. 
            I liked it a lot.

        </p>

        <p> <img src="./medias/images/Leadership/La_Haine_affiche.jpg" alt="The poster of the french Movie La Haine" class="float_left"> </p>
